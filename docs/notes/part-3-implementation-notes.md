...
After starting, changing, blocking, or finishing any stage, update `docs/reports/part-3-stage-report.md` immediately.

## Source of Truth

When there is any conflict, use these documents in this order:

1. `docs/plans/project-master-plan.md`
2. `docs/plans/feature-tab-mapping.md`
3. `docs/reference/api-structure.md`
4. `AGENT.md`

How to interpret them:

- `docs/plans/project-master-plan.md` is the main contract for Team 3 routes, files, stage order, and deliverables.
- `docs/plans/feature-tab-mapping.md` defines the employee-facing use cases, Q360 tabs to mirror, main data tables, and Team 2 integration points.
- `docs/reference/api-structure.md` defines the real Q360 auth and request rules.
...
- if a route has no real user context yet, use a clearly documented temporary current-user assumption in `docs/reports/part-3-stage-report.md`
...
- document the missing dependency in `docs/reports/part-3-stage-report.md`
...
- a completed Stage 0 report entry in `docs/reports/part-3-stage-report.md`
...
- anyone reading `docs/reports/part-3-stage-report.md` can understand the repo baseline without reopening all the docs
...
- confirm `docs/reports/part-3-stage-report.md` includes blockers, next step, and current data mode
...
Whenever a stage changes, update `docs/reports/part-3-stage-report.md` immediately.

Each stage entry in `docs/reports/part-3-stage-report.md` must include:
...
If a stage is not truly demoable yet, do not call it complete. Mark it `in progress` or `blocked`, explain why in `docs/reports/part-3-stage-report.md`, and keep moving with the parts that are not blocked.
